...
export const PHOSPHOR_CATEGORIES: Record<string, { name: string; d: string }[]> = {
  "Interface": [
...
export function PhosphorSvg({ d, size = 20, color = "currentColor" }: { d: string; size?: number; color?: string }) {
  return (
...
export function getPhosphorPath(name: string): string | null {
...
export function PhosphorIconSelect({ value, onChange, allowEmpty = false, placeholder = "Ícone" }: {
