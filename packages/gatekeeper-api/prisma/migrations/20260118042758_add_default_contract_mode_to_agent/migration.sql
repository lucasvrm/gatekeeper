...
CREATE TABLE "new_LLMAgent" (
    ...
    "defaultContractMode" TEXT NOT NULL DEFAULT 'STRICT',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_LLMAgent" ("apiKey", "apiKeyEnvVar", "baseUrl", "createdAt", "generateLog", "generatePlanJson", "generateSpecFile", "generateTaskPrompt", "id", "isActive", "isDefault", "maxTokens", "model", "name", "projectPath", "provider", "slug", "sortOrder", "systemPromptId", "temperature", "updatedAt") SELECT "apiKey", "apiKeyEnvVar", "baseUrl", "createdAt", "generateLog", "generatePlanJson", "generateSpecFile", "generateTaskPrompt", "id", "isActive", "isDefault", "maxTokens", "model", "name", "projectPath", "provider", "slug", "sortOrder", "systemPromptId", "temperature", "updatedAt" FROM "LLMAgent";
DROP TABLE "LLMAgent";
