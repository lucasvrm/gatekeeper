...
async function main() {
  ...
  const validatorConfigs = [
    ...
    { key: 'CONTRACT_SCHEMA_VALID', value: 'true', type: 'BOOLEAN', category: 'VALIDATOR' },
    { key: 'TEST_CLAUSE_MAPPING_VALID', value: 'true', type: 'BOOLEAN', category: 'VALIDATOR' },
    { key: 'CONTRACT_CLAUSE_COVERAGE', value: 'true', type: 'BOOLEAN', category: 'VALIDATOR' },
    { key: 'NO_OUT_OF_CONTRACT_ASSERTIONS', value: 'true', type: 'BOOLEAN', category: 'VALIDATOR' },
